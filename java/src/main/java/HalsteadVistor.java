...
public class HalsteadVistor extends ASTVisitor {
	...
	// if the expression's operator doesn't exist in the operator hashmap, insert
	// it, otherwise, increment the count field.
	...
	// if the assignment's operator doesn't exist in the operator hashmap, insert
	// it, otherwise, increment the count field.
	...
	// add the "=" operators to the hashmap of operators if the variable is
	// initialized
	...
	// if the SimpleName doesn't exist in the names hashmap, insert it, otherwise,
	...
	// if the null doesn't exist in the names hashmap, insert it, otherwise,
	// increment the count field.
	...
	// if the string literal doesn't exist in the names hashmap, insert it,
	// otherwise, increment the count field.
	...
	// if the character literal doesn't exist in the names hashmap, insert it,
	// otherwise, increment the count field.
	...
	// if the boolean literal doesn't exist in the names hashmap, insert it,
	// otherwise, increment the count field.
	...
	// if the Number literal doesn't exist in the names hashmap, insert it,
	// otherwise, increment the count field.
